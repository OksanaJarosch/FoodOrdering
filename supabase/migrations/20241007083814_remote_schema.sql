...
CREATE POLICY "Authenticated users, all operations" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "Authenticated users, all operations" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);
